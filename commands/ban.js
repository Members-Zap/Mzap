...
module.exports = {
  name: "ban",
  description: "interdit à un utilisateur d'utiliser le bot, propriétaire uniquement.",
  execute: async(client, message, args, data, db) => {
    ...
    if (user === undefined) return message.channel.send(`**Je ne parviens pas à trouver cet utilisateur!**`)
